...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'chatty.com'
  config.app_name = 'Chatty'
  config.mailer.from = 'Chatty <no-reply@chatty.com>'
  ...
  #
  config.app_secret = 'UvdQ9UYYDTT2dyRWDL7aPjObtEeaoTmM38tHdp-UALjq9GU38I8dHvYJrNKwBhoX4IE'
